package Challenges.RegistrationSystem.Services;
import Challenges.RegistrationSystem.Domain.Pet;
import Challenges.RegistrationSystem.Domain.enums.PetType;
import java.io.*;
...
public class PetSystem {
    ...
    private static void changePet(String name, Scanner input){
        ...
        Path dir = Paths.get("src", "Challenges/RegistrationSystem", "RegisteredPets");
        try(DirectoryStream<Path> stream = Files.newDirectoryStream(dir)) {
            for(Path path : stream) {
