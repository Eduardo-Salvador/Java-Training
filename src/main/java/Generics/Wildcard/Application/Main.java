...
public class Main {
    public static void main(String[] args) {
        ...
        AnimalManager.add(animals, dogs.get(0));
        AnimalManager.add(animals, dogs.get(1));
        AnimalManager.printAnimalSounds(animals);
        System.out.println("----------------");

        //AnimalManager.add(animals, cats.get(0));
        //AnimalManager.add(animals, cats.get(1));
        AnimalManager.printAnimalSounds(animals);
        System.out.println("----------------");

        AnimalManager.add(animals, lions.getFirst());
        AnimalManager.printAnimalSounds(animals);
        System.out.println("----------------");
    }
}