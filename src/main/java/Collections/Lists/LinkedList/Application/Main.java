package Collections.Lists.LinkedList.Application;

import Collections.Lists.LinkedList.Services.QueueManager;
import Collections.Lists.LinkedList.Domain.Customer;
